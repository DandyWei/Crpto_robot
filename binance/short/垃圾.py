...
df_list = []
# 数据起点时间
last_datetime = dt.datetime(2021,3, 29)
...
#         print(self.val_start)
        ...
        self.surely_conditions_short = self.sc7 and self.sc9  and self.sc6 and self.sc8 and ( self.sc5 or self.c1)
