...
class info_trade:
    def __init__(self,):
        logging.basicConfig(level=logging.INFO,
                            ...
                            style="{")
        self.__api_key = 'nux5568AFIq0eL63qdQpsFHgG08nKGg3aO3FRDduzxhxOTx3l3FN1kpMTyXbE8it'
        self.__api_secret = 'kgj4GJz65eqaumiBH0Bgu4L7eaG4eVqJc9u6UZ12ykChYaMgbN6fZDzYr5EO0fyl'
